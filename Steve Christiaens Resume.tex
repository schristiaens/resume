	...
	\begin{description}
		\resitem[Technologies \& Software]\
			\begin{list}{}{\leftmargin=0em \itemindent=0em \footnotesize}
				\resitem {Burp Suite, MetaSploit, SSH, Java, Python, Ruby, JavaScript, GIT, Microsoft Office}
			\end{list}
		\resitem[Computer \& OS]\
			\begin{list}{}{\leftmargin=0em \itemindent=0em \footnotesize}
				\resitem {MacOS, Windows, Linux, Android; In-depth H/W and S/W knowledge and troubleshooting techniques;  Virtualization using VMware/vSphere/VirtualBox; Penetration testing}\
  			\end{list}
		\resitem[Other]\
			\begin{list}{}{\leftmargin=0em \itemindent=0em \footnotesize}
				\resitem{Presented Internet of Things research at Kennesaw State University, GreyH@t at Georgia Tech, and ITAC 2015}
				\resitem{Placed 1\textsuperscript{st} with teams at regional hacking competitions: 2014 NIATEC CCDC, 2012 SAIC UCDC}
				\resitem{Photography, Rock Climbing, Cooking}
  			\end{list}
