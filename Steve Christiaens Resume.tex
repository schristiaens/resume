...
\resheading{Experience}
	...
	\item
			...
			\begin{itemize}
				...
				\resitem{Create customized deliverables for clients explaining how vulnerabilities are discovered, how to reproduce them, and best practices for remediation}
				\resitem{Lead wireless penetration testing engagements covering Wi-Fi, Bluetooth, and Zigbee protocols}
			\end{itemize}
			}
		\item 
